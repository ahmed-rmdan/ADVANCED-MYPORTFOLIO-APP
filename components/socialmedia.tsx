...
return(
                      ...
                      <motion.a  viewport={{once:true,amount:0.2}} whileInView={{opacity:100}} transition={{duration:3}} 
                      ...
                      className="  max-w-full max-h-full " fill 
                       src={githublogo.src}></Image>   
                            ...
                            <motion.a  viewport={{once:true,amount:0.2}} whileInView={{opacity:100}} transition={{duration:4}} 
                             ...
                             <motion.a   viewport={{once:true,amount:0.2}} whileInView={{opacity:100}} transition={{duration:5}}   
