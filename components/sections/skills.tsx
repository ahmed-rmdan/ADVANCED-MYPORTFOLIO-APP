...
return(
           <div id="section-3" className="flex  flex-col w-full pb-10  items-center bg-[#000020] text-[3.7px] gap-[20px] sm:text-[4.5px] lg:text-[5.5px] xl:text-[7px] ">
                 ...
                 <motion.h1  initial={{opacity:0}} transition={{duration:2}} viewport={{once:true,amount:0.3}} whileInView={{opacity:100}} 
                 className="text-[6.5em] underline font-extrabold text-[#0077b6] mt-[20px]"> MY Skills</motion.h1>
                 <motion.div initial={{opacity:0}} transition={{duration:2}} viewport={{once:true,amount:0.25}} whileInView={{opacity:100}} className="w-full flex justify-center items-center">
